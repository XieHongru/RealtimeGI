...
public class PathTracingRenderPass : ScriptableRenderPass
{
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        rayTracingShader.SetVector(Shader.PropertyToID("_SunColor"), sunColor);

        rayTracingShader.SetTexture(Shader.PropertyToID("g_Radiance"), rayTracingOutput);
        rayTracingShader.Dispatch("MainRayGenShader", (int)camera.pixelWidth, (int)camera.pixelHeight, 1);
